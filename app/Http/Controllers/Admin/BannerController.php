...
class BannerController extends Controller
{
    ...
    {        
        $validator = Validator::make($request->all(), [
            ...
            'store_id.required_if'=> trans('messages.store is required when banner type is store wise'),
            'item_id.required_if'=> trans('validation.required_if',['attribute'=>trans('messages.item'), 'other'=>trans('messages.banner').' '.trans('messages.type'), 'value'=>trans('messages.item_wise')]),
        ]);
    ...
    public function featured(Request $request)
    {
        ...
        $banner->save();
        Toastr::success(trans('messages.banner_featured_status_updated'));
        return back();
    }
