...
class ParcelCategoryController extends Controller
{
    ...
    {
        $parcel_categories = ParcelCategory::orderBy('name')->paginate(config('default_pagination'));
    ...
    public function store(Request $request)
    {
        ...
        Toastr::success(trans('messages.parcel_category_added_successfully'));
        return back();
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Toastr::success(trans('messages.parcel_category_updated_successfully'));
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        Toastr::success(trans('messages.parcel_category_deleted_successfully'));
        return back();
    }
    ...
    public function status(Request $request)
    {
        ...
        $parcel_category->save();
        Toastr::success(trans('messages.parcel_category_status_updated'));
        return back();
    }
}
