...
class ItemController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if(!$product)
        {
            Toastr::error(trans('messages.item').' '.trans('messages.not_found'));
            return back();
        }
    ...
    public function status(Request $request)
    {
        ...
        $product->save();
        Toastr::success(trans('messages.item_status_updated'));
        return back();
    }
    ...
    {
        $items = Item::withoutGlobalScope(StoreScope::class)->with('store')->whereHas('store', function($query)use($request){
    ...
    public function bulk_import_data(Request $request)
    {
        ...
        foreach ($collections as $collection) {
                if ($collection['name'] === "" || $collection['category_id'] === "" || $collection['sub_category_id'] === "" || $collection['price'] === "" || empty($collection['available_time_starts']) === "" || empty($collection['available_time_ends']) || $collection['store_id'] === "") {
