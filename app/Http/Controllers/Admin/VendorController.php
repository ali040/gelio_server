...
class VendorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Toastr::success(trans('messages.store').trans('messages.added_successfully'));
    ...
    public function edit($id)
    {
        ...
        {
            Toastr::warning(trans('messages.you_can_not_edit_this_store_please_add_a_new_store_to_edit'));
            return back();
        }
    ...
    public function update(Request $request, Store $store)
    {
        ...
        $store->delivery_time = $request->minimum_delivery_time .'-'. $request->maximum_delivery_time.' '.$request->delivery_time_type;
        $store->save();
        Toastr::success(trans('messages.store').trans('messages.updated_successfully'));
        return redirect('admin/vendor/list');
    }
    ...
    public function destroy(Request $request, Store $store)
    {
        ...
        {
            Toastr::warning(trans('messages.you_can_not_delete_this_store_please_add_a_new_store_to_delete'));
            return back();
        }
        ...
        $vendor = Vendor::findOrFail($store->vendor->id);
        $vendor->delete();
        Toastr::success(trans('messages.store').' '.trans('messages.removed'));
        return back();
    }
    ...
    public function get_stores(Request $request){
        ...
        $data = Store::join('zones', 'zones.id', '=', 'stores.zone_id')
    ...
    public function status(Store $store, Request $request)
    {
        ...
        Toastr::success(trans('messages.store').trans('messages.status_updated'));
        return back();
    }
    ...
    public function store_status(Store $store, Request $request)
    {
        ...
        $store->save();
        Toastr::success(trans('messages.store').trans('messages.settings_updated'));
        return back();
    }
    ...
    public function discountSetup(Store $store, Request $request)
    {
        ...
        $message .= $store->discount?trans('messages.updated_successfully'):trans('messages.added_successfully');
    ...
    public function cleardiscount(Store $store)
    {
        ...
        Toastr::success(trans('messages.store').trans('messages.discount_cleared'));
        return back();
    }
    ...
    public function bulk_import_data(Request $request)
    {
        ...
        foreach ($collections as $key=>$collection) {
                if ($collection['ownerFirstName'] === "" || $collection['storeName'] === "" || $collection['phone'] === "" || $collection['email'] === "" || $collection['latitude'] === "" || $collection['longitude'] === "" || empty($collection['openingTime']) === "" || empty($collection['closeingTime']) || $collection['zone_id'] === "" || $collection['module_id'] === "") {
        ...
        try{
            ...
            DB::table('store_schedules')->insert($data);
            DB::commit();
        }catch(\Exception $e)
        {
            DB::rollBack();
        ...
        Toastr::success(trans('messages.store_imported_successfully',['count'=>count($stores)]));
        return back();
    }
    ...
    public function featured(Request $request)
    {
        ...
        $store->save();
        Toastr::success(trans('messages.store_featured_status_updated'));
        return back();
    }
}
