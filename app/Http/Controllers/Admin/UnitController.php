...
class UnitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Toastr::success(trans('messages.unit_added_successfully'));
        return back();
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Toastr::success(trans('messages.unit_updated_successfully'));
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        Toastr::success(trans('messages.unit_deleted_successfully'));
        return back();
    }
}
