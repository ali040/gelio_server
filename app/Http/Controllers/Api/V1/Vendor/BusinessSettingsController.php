...
class BusinessSettingsController extends Controller
{
    ...
    public function update_store_setup(Request $request)
    {
        ...
        return response()->json(['message'=>trans('messages.store_settings_updated')], 200);
    }
    ...
    public function add_schedule(Request $request)
    {
        ...
        return response()->json(['message'=>trans('messages.Schedule added successfully'), 'id'=>$store_schedule], 200);
    }
