...
class POSController extends Controller
{
    public function place_order(Request $request)
    {
        ...
        // {
        //     Toastr::warning(trans('messages.you_need_to_order_at_least', ['amount'=>$store->minimum_order.' '.Helpers::currency_code()]));
        //     return back();
        // }
        // dd(['pro'=>$product_price, 'add'=>$total_addon_price, 'discount'=>$store_discount_amount, 'tax'=>$total_tax_amount ,'cart'=>$cart]);
