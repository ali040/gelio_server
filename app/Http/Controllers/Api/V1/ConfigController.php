...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'canceled_by_store' => (boolean)BusinessSetting::where(['key' => 'canceled_by_store'])->first()->value,
            ...
            'toggle_store_registration' => (boolean)BusinessSetting::where(['key' => 'toggle_store_registration'])->first()->value,
            ...
            'module'=>$module,
            'parcel_per_km_shipping_charge' => (float)BusinessSetting::where(['key' => 'parcel_per_km_shipping_charge'])->first()->value,
            'parcel_minimum_shipping_charge' => (float)BusinessSetting::where(['key' => 'parcel_minimum_shipping_charge'])->first()->value,
        ]);
    }
