...
class BusinessSettingsController extends Controller
{
    ...
    public function store_setup(Store $store, Request $request)
    {
        ...
        $store->save();
        Toastr::success(trans('messages.store_settings_updated'));
        return back();
    }
    ...
    public function store_status(Store $store, Request $request)
    {
        ...
        $store->save();
        Toastr::success(trans('messages.store settings updated!'));
        return back();
    }
    ...
    public function active_status(Request $request)
    {
        ...
        $store->save();
        return response()->json(['message' => $store->active?trans('messages.store_opened'):trans('messages.store_temporarily_closed')], 200);
    }
