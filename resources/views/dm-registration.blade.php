        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-center"><i class="tio-add-circle-outlined"></i> {{__('messages.deliveryman_application')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="l_name" class="form-control" placeholder="{{__('messages.last')}} {{__('messages.name')}}" value="{{old('l_name')}}"
                                       required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="Ex : ex@example.com" value="{{old('email')}}"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="identity_type" class="form-control">
                                    ...
                                    <option value="store_id">{{__('messages.store')}} {{__('messages.id')}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="tel" name="tel" id="phone" placeholder="Ex : 017********" class="form-control" value="{{old('tel')}}" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="password" class="form-control" placeholder="Ex : password" value="{{old('password')}}"
                                    required>
                            </div>
                        </div>
                    </div>
