        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content text-capitalize"  style="background-color: #334257;">
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('vendor-panel/order*')?'active':''}}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li class="nav-item {{Request::is('vendor-panel/order/list/item_on_the_way')?'active':''}}">
                                <a class="nav-link" href="{{route('vendor.order.list',['item_on_the_way'])}}" title="{{__('messages.items_on_the_way')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">
                    ...
                    <li class="nav-item">
                        <small
                            class="nav-subtitle">{{__('messages.item')}} {{__('messages.management')}}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('vendor-panel/item*')?'active':''}}">
                        ...
                        >
                            ...
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{__('messages.items')}}</span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                ...
                <!-- End DeliveryMan -->
                    ...
                    <li class="nav-item {{Request::is('vendor-panel/business-settings/store-setup')?'active':''}}">
                        <a class="nav-link " href="{{route('vendor.business-settings.store-setup')}}" title="{{__('messages.store')}} {{__('messages.config')}}"
                        >
                            <span class="tio-settings nav-icon"></span>
                            <span
                                class="text-truncate">{{__('messages.store')}} {{__('messages.config')}}</span>
                        </a>
                    </li>
                    @endif
