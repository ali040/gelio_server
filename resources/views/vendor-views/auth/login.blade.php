...
<head>
    ...
    <!-- Title -->
    <title>{{__('messages.store')}} | {{__('messages.login')}}</title>
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <div class="text-center">
                            <div class="mb-5">
                                <h1 class="display-4">{{__('messages.store')}} {{__('messages.sign_in')}}</h1>
                        ...
                        <form class="login_form" action="{{route('vendor.auth.login')}}" method="post" id="vendor_login_form" style="display: none;">
                            ...
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4">{{__('messages.store_owner_login_form')}}</span>
                                </div>
                            </div>
                        ...
                        <form class="login_form" action="{{route('vendor.auth.employee.login')}}" method="post" id="employee_login_form" style="display: none;">
                            ...
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4">{{{__('messages.store_employee_login_form')}}}</span>
                                </div>
                            </div>
                            <!-- Form Group -->
                            <div class="js-form-message form-group">
