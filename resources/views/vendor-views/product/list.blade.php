...
@section('title',__('messages.item_list'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{__('messages.item')}} {{__('messages.list')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$items->total()}}</span></h1>
                </div>
                ...
                <div class="col-sm-auto">
                    <a href="{{route('vendor.item.add-new')}}" class="btn btn-primary pull-right"><i
                                class="tio-add-circle"></i> {{__('messages.add')}} {{__('messages.new')}} {{__('messages.item')}}</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-white"
                                            href="{{route('vendor.item.edit',[$item['id']])}}" title="{{__('messages.edit')}} {{__('messages.item')}}"><i class="tio-edit"></i>
                                        </a>
                                        <a class="btn btn-sm btn-white" href="javascript:"
                                            onclick="form_alert('food-{{$item['id']}}','Want to delete this item ?')" title="{{__('messages.delete')}} {{__('messages.item')}}"><i class="tio-delete-outlined"></i>
                                        </a>
