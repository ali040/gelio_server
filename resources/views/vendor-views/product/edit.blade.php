                ...
                <form action="javascript:" method="post" id="product_form"
                        ...
                        @foreach(json_decode($language) as $lang)
                            ...
                            <div class="card p-4 {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" {{$lang == $default_lang? 'required':''}} name="name[]" id="{{$lang}}_name" class="form-control" placeholder="{{__('messages.new_item')}}" value="{{$translate[$lang]['name']??$product['name']}}" oninvalid="document.getElementById('en-link').click()">
                                </div>
                    ...
                    <div class="card p-4" id="{{$default_lang}}-form">
                        <div class="form-group">
                            ...
                            <input type="text" name="name[]" class="form-control" placeholder="{{__('messages.new_item')}}" value="{{$product['name']}}" required>
                        </div>
