...
@section('title',__('messages.edit_store'))
@push('css_or_js')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="h3 mb-0 text-capitalize">{{__('messages.edit')}} {{__('messages.store')}} {{__('messages.info')}}</h1>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">{{__('messages.store')}} {{__('messages.name')}} <span class="text-danger">*</span></label>
