...
<div class="modal-body">
    <div class="d-flex flex-row">
        @if(config('toggle_veg_non_veg') && config('module.'.\App\CentralLogics\Helpers::get_store_data()->module->module_type)['veg_non_veg'])
        ...
        <div class="details pl-2">
            <a href="{{route('vendor.item.view',$product->id)}}" class="h3 mb-2 product-title text-capitalize text-break">{{$product->name}}</a>
