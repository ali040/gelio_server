        ...
        <div class="page-header p-0">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{__('messages.store')}} {{__('messages.setup')}}</h1>
                </div>
                        ...
                        <div class="card-body" style="padding-bottom: 12px">
                            <div class="d-flex flex-row justify-content-between ">
                                    ...
                                    <h5 class="text-capitalize">
                                        ...
                                        {{__('messages.store_temporarily_closed_title')}}
                                    </h5>
    ...
    <script>
        function restaurant_open_status(e) {
            Swal.fire({
                ...
                text: '{{$store->active ? __('messages.you_want_to_temporarily_close_this_store') : __('messages.you_want_to_open_this_store') }}',
                type: 'warning',
