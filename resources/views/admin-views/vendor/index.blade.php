...
@section('title',__('messages.add_new_store'))
        ...
        <div class="page-header" style="border-bottom:0;padding-bottom:0;">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{__('messages.add')}} {{__('messages.new')}} {{__('messages.store')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="address" class="form-control" placeholder="{{__('messages.store')}} {{__('messages.address')}}" required >{{old('address')}}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="delivery_time_type" class="form-control text-capitalize" id="" required>
                                        <option value="min">{{__('messages.minutes')}}</option>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <select name="module_id" required
                                        class="form-control js-select2-custom"  data-placeholder="{{__('messages.select')}} {{__('messages.module')}}">
                                        <option value="" selected disabled>{{__('messages.select')}} {{__('messages.module')}}</option>
                                    @foreach(\App\Models\Module::notParcel()->get() as $module)
                                        <option value="{{$module->id}}">{{$module->module_name}}</option>
                                    @endforeach
                                </select>
                                <small class="text-danger">{{__('messages.module_change_warning')}}</small>
                            </div>
                            <div class="form-group">
