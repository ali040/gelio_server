        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{route('admin.vendor.list')}}">{{trans('messages.stores')}}</a>
                </li>
                <li class="breadcrumb-item">{{trans('messages.bulk_import')}} </li>
            </ol>
        </nav>
        <h1 class="text-capitalize">{{__('messages.stores')}} {{__('messages.bulk_import')}}</h1>
        <!-- Content Row -->
        <div class="row">
            <div class="col-12">
                <div class="jumbotron pt-1" style="background: white">
                    ...
                    <p>6. You can upload your store images in store folder from gallery, and copy image`s path.</p>
                    
                    <p>7. Default password for store is 12345678.</p>
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="col-12">
                                        <div class="form-group py-2" id="module">
                                            ...
                                            <select name="module_id" class="form-control js-select2-custom"  data-placeholder="{{__('messages.select')}} {{__('messages.module')}}">
