                ...
                <div class="col-md-12">
                    <div class="card h-100">
                        <div class="card-header">
                            {{__('messages.store')}} {{__('messages.settings')}}
                        </div>
                        <div class="card-body">
                            <div class="row justify-content-md-center">
                                <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2">{{__('messages.item_section')}}<span class="input-label-secondary" title="{{__('messages.show_hide_food_menu')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.show_hide_food_menu')}}"></span> :</span> 
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2">{{__('messages.free_delivery')}}:</span> 
                                            <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('admin.vendor.toggle-settings',[$store->id,$store->free_delivery?0:1, 'free_delivery'])}}'" id="free_delivery" {{$store->free_delivery?'checked':''}}>
                                ...
                                <div class="card-body">
                                    <form action="{{route('admin.vendor.update-settings',[$store['id']])}}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label class="input-label text-capitalize" for="maximum_delivery_time">{{__('messages.minimum_processing_time')}}<span class="input-label-secondary" title="{{__('messages.minimum_processing_time_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.minimum_processing_time_warning')}}"></span></label>
                                                <input type="text" name="order_place_to_schedule_interval" class="form-control" value="{{$store->order_place_to_schedule_interval}}">
                                            </div>
                                            @endif
                                            <div class="form-group col-md-4">
                                                <label class="input-label text-capitalize" for="maximum_delivery_time">{{__('messages.approx_delivery_time')}}</label>
