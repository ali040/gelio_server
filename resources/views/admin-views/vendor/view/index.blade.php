        ...
        <div class="for-card col-md-4 mb-1">
            <div class="card for-card-body-2 shadow h-100 text-white"  style="background: #8d8d8d;">
                ...
                <div class="card-footer"  style="background: #8d8d8d; border:none;">
                        <a class="btn w-100" style="background: #f9fafc;" href="{{route('admin.account-transaction.index')}}" title="{{__('messages.goto')}} {{__('messages.account_transaction')}}">{{__('messages.collect_cash_from_store')}}</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-6">
                            <div class="card mt-2">
                                ...
                                {{__('messages.store')}} {{__('messages.info')}}
                                </div>
                                <div class="card-body">
                                    <ul class="list-unstyled list-unstyled-py-3 text-dark mb-3">
                                        ...
                                        <li>
                                            ...
                                            {{__('messages.address')}} : {{$store->address}}
                                        </li>
                        ...
                        <div class="col-md-8 col-6">
                            <div class="card mt-2">
                                <div class="card-header">
                                {{__('messages.store')}} {{__('messages.location')}}
                                </div>
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <ul class="list-unstyled list-unstyled-py-3 text-dark mb-3">
                                        ...
                                        <li class="pb-1 pt-1">
                                            {{__('messages.bank_name')}}: {{$store->vendor->bank_name ? $store->vendor->bank_name : 'No Data found'}}
                                        </li>
                                        <li class="pb-1 pt-1">
                                            {{__('messages.branch')}}  : {{$store->vendor->branch ? $store->vendor->branch : 'No Data found'}}
                                        </li>
                                        <li class="pb-1 pt-1">
                                            {{__('messages.holder_name')}} : {{$store->vendor->holder_name ? $store->vendor->holder_name : 'No Data found'}}
                                        </li>
                                        <li class="pb-1 pt-1">
                                            {{__('messages.account_no')}}  : {{$store->vendor->account_no ? $store->vendor->account_no : 'No Data found'}}
                                        </li>
                                        @else
                                        <li class="my-auto">
