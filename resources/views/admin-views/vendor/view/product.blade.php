                ...
                <div class="col-md-12">
                    <div class="card h-100">
                        <div class="card-header">
                            <h3>{{__('messages.items')}} <span class="badge badge-soft-dark ml-2">{{$foods->total()}}</span></h3>
                        ...
                        <div class="table-responsive datatable-custom">
                            <table id="columnSearchDatatable"
                                ...
                                <tr>
                                    ...
                                    <td>
                                    {{Str::limit($food->category?$food->category->name:__('messages.category_deleted'),20,'...')}}
                                    </td>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-white"
                                            href="{{route('admin.item.edit',[$food['id']])}}" title="{{__('messages.edit')}} {{__('messages.item')}}"><i class="tio-edit"></i>
                                        </a>
                                        <a class="btn btn-sm btn-white" href="javascript:"
                                            onclick="form_alert('food-{{$food['id']}}','Want to delete this item ?')" title="{{__('messages.delete')}} {{__('messages.item')}}"><i class="tio-delete-outlined"></i>
                                        </a>
