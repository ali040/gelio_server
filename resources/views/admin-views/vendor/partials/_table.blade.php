    ...
    <tr>
        ...
        <td>
            <a class="btn btn-sm btn-white"
                href="{{route('admin.vendor.view',[$dm['id']])}}" title="{{__('messages.view')}} {{__('messages.store')}}"><i class="tio-visible text-success"></i>
            </a>
            <a class="btn btn-sm btn-white"
                href="{{route('admin.vendor.edit',[$dm['id']])}}" title="{{__('messages.edit')}} {{__('messages.store')}}"><i class="tio-edit text-primary"></i>
            </a>
            {{--<a class="btn btn-sm btn-white" href="javascript:"
            onclick="form_alert('vendor-{{$dm['id']}}','Want to remove this information ?')" title="{{__('messages.delete')}} {{__('messages.store')}}"><i class="tio-delete-outlined text-danger"></i>
            </a>
