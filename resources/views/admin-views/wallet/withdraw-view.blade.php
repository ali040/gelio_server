...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{__('messages.store')}} {{__('messages.withdraw')}}</li>
        </ol>
    </nav>
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header p-3">
                    <h3 class="text-center text-capitalize">
                        {{trans('messages.store')}} {{trans('messages.withdraw')}} {{trans('messages.information')}}
                    </h3>
        ...
        @if($wr->vendor->restaurants)
            <div class="col-md-4">
                <div class="card" style="min-height: 260px;">
                    <div class="card-header">
                        <h3 class="h3 mb-0">{{trans('messages.store')}} {{trans('messages.info')}}</h3>
                        <i class="tio tio-shop-outlined"></i>
                    </div>
                    <div class="card-body">
                        <h5>{{trans('messages.store')}} : {{$wr->vendor->stores[0]->name}}</h5>
                        <h5>{{trans('messages.phone')}} : {{$wr->vendor->stores[0]->contact}}</h5>
                        <h5>{{trans('messages.address')}} : {{$wr->vendor->stores[0]->address}}</h5>
