                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="store_id" id="store_id" class="js-data-example-ajax form-control"  data-placeholder="{{__('messages.select')}} {{__('messages.store')}}" oninvalid="this.setCustomValidity('{{__('messages.please_select_store')}}')">
        ...
        <div class="card mt-1">
            <div class="card-header">
                ...
                <div class="col-sm-auto" style="width: 306px;">
                    <select name="store_id" id="store" onchange="set_store_filter('{{route('admin.addon.add-new')}}',this.value)" data-placeholder="{{__('messages.select')}} {{__('messages.store')}}" class="js-data-example-ajax form-control"   title="Select Restaurant">
                    @if(isset($store))    
                    <option value="{{$store->id}}" selected>{{$store->name}}</option>
                    @else
                    <option value="all" selected>{{__('messages.all_stores')}}</option>
                    @endif
                    </select>
                </div>
            </div>
                        ...
                        <div id="showHideDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right dropdown-card" style="width: 15rem;">
                            <div class="card card-sm">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="mr-2">{{__('messages.store')}}</span>
                ...
                <div class="table-responsive datatable-custom">
                    <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"  data-hs-datatables-options='{
                        ...
                        <tr>
                            ...
                            <th style="width: 30%">{{__('messages.store')}}</th>
                        ...
                        @foreach($addons as $key=>$addon)
                            <tr>
                                ...
                                <td>{{Str::limit($addon->store?$addon->store->name:__('messages.store').' '.__('messages.deleted'),25,'...')}}</td>
                                <td>    
