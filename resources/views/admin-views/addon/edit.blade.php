                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="store_id" class="form-control  js-data-example-ajax"  data-placeholder="{{__('messages.select')}} {{__('messages.store')}}" required oninvalid="this.setCustomValidity('{{__('messages.please_select_store')}}')">
                                @if($addon->store)
