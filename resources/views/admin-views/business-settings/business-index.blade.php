                ...
                <form action="{{route('admin.business-settings.update-setup')}}" method="post"
                        ...
                        <div class="col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="store" name="order_confirmation_model"
                                                   id="order_confirmation_model" {{$order_confirmation_model=='store'?'checked':''}}>
                                            <label class="custom-control-label" for="order_confirmation_model">{{__('messages.store')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{__('messages.store_cancellation_toggle')}}</label><small style="color: red">
                                <!-- <span class="input-label-secondary" title="{{__('messages.customer_varification_toggle')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.customer_varification_toggle')}}"></span> -->
                                 *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1" name="canceled_by_store"
                                                   id="canceled_by_store" {{$canceled_by_store==1?'checked':''}}>
                                            <label class="custom-control-label" for="canceled_by_store">{{__('messages.yes')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0" name="canceled_by_store"
                                                   id="canceled_by_store2" {{$canceled_by_store==0?'checked':''}}>
                                            <label class="custom-control-label" for="canceled_by_store2">{{__('messages.no')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{__('messages.store_self_registration')}}</label><small style="color: red"><span
                                        class="input-label-secondary" title="{{__('messages.store_self_registration')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.store_self_registration')}}"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1" name="store_self_registration"
                                                   id="store_self_registration1" {{$store_self_registration==1?'checked':''}}>
                                            <label class="custom-control-label" for="store_self_registration1">{{__('messages.on')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0" name="store_self_registration"
                                                   id="store_self_registration2" {{$store_self_registration==0?'checked':''}}>
                                            <label class="custom-control-label" for="store_self_registration2">{{__('messages.off')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
