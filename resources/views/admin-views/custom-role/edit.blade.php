                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label qcont text-dark" for="food">{{__('messages.item')}}</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group form-check">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="restaurant" class="form-check-input"
                                           id="restaurant"  {{in_array('store',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label qcont text-dark" for="restaurant">{{__('messages.stores')}}</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group form-check">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label qcont text-dark" for="withdraw_list">{{__('messages.store')}} {{__('messages.withdraws')}}</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group form-check">
