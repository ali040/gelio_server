...
@section('title',__('messages.parcel_settings'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-capitalize">{{__('messages.parcel_settings')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label  class="input-label d-inline text-capitalize">{{__('messages.per_km_shipping_charge')}}</label>
                                        <input type="number" step=".01" placeholder="{{__('messages.per_km_shipping_charge')}}" class="form-control" name="parcel_per_km_shipping_charge"
                                            value="{{env('APP_MODE')!='demo'?$parcel_per_km_shipping_charge??'':''}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="input-label d-inline text-capitalize">{{__('messages.minimum_shipping_charge')}}</label>
                                        <input type="number" step=".01" placeholder="{{__('messages.minimum_shipping_charge')}}" class="form-control" name="parcel_minimum_shipping_charge"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="input-label d-inline text-capitalize">{{__('messages.deliveryman_commission')}} (%)</label>
                                        <input type="number" step=".01" placeholder="{{__('messages.deliveryman_commission')}}" class="form-control" name="parcel_commission_dm" max="100" value="{{env('APP_MODE')!='demo'?$parcel_commission_dm??'':''}}">
                                    </div>
                                </div>
                            </div>
