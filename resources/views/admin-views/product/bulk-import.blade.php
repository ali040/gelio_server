...
@section('title','Item Bulk Import')
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{route('admin.item.list')}}">{{trans('messages.items')}}</a>
                </li>
                <li class="breadcrumb-item">{{trans('messages.bulk_import')}} </li>
            </ol>
        </nav>
        <h1 class="text-capitalize">{{__('messages.items')}} {{__('messages.bulk_import')}}</h1>
        <!-- Content Row -->
        <div class="row">
            <div class="col-12">
                <div class="jumbotron pt-1" style="background: white">
                    ...
                    <p>3. Once you have downloaded and filled the format file, upload it in the form below and
                        submit.</p>
                    <p>4. You can get store id, module id and unit id from their list, please input the right ids.</p>
                    
                    <p>5. For ecommerce item avaliable time start and end will be 00:00:00 and 23:59:59</p>
