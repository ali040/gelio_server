        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i> {{__('messages.item')}} {{__('messages.update')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="module_id" required class="form-control js-select2-custom"  data-placeholder="{{__('messages.select')}} {{__('messages.module')}}" onchange="modulChange(this.value)" disabled>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">{{__('messages.store')}}<span
                                        class="input-label-secondary"></span></label>
                                <select name="store_id" data-placeholder="{{__('messages.select')}} {{__('messages.store')}}" id="store_id" class="js-data-example-ajax form-control" onchange="getStoreData('{{url('/')}}/admin/vendor/get-addons?data[]=0&store_id=', this.value,'add_on')"  title="Select Store" required oninvalid="this.setCustomValidity('{{__('messages.please_select_store')}}')">
                        ...
                        <div class="col-sm-6" id="addon_input">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">{{__('messages.addon')}}<span
                                        class="input-label-secondary" title="{{__('messages.store_required_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.store_required_warning')}}"></span></label>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <a href="{{route('admin.item.remove-image',['id'=>$product['id'],'name'=>$photo])}}"
                                                    class="btn btn-danger btn-block">{{__('messages.remove')}}</a>
