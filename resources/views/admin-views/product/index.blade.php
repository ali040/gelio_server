...
@section('title',__('messages.add_new_item'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{__('messages.add')}} {{__('messages.new')}} {{__('messages.item')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <form action="javascript:" method="post" id="item_form"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="module_id" required class="form-control js-select2-custom"  data-placeholder="{{__('messages.select')}} {{__('messages.module')}}" onchange="modulChange(this.value)">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="input-label" for="store_id">{{__('messages.store')}}<span
                                        class="input-label-secondary"></span></label>
                                <select name="store_id" data-placeholder="{{__('messages.select')}} {{__('messages.store')}}" id="store_id" class="js-data-example-ajax form-control" onchange="getRestaurantData('{{url('/')}}/admin/vendor/get-addons?data[]=0&store_id=',this.value,'add_on')" oninvalid="this.setCustomValidity('{{__('messages.please_select_store')}}')">
                    ...
                    <div class="row">
                        <div class="col-6" id="unit_input">
                            <div class="form-group">
                                <label class="input-label text-capitalize" for="unit">{{__('messages.unit')}}</label>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="category_id">{{__('messages.category')}}<span
                                        class="input-label-secondary">*</span></label>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="sub-categories">{{__('messages.sub_category')}}<span
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-6" id="stock_input">
                            <div class="form-group">
                                <label class="input-label" for="total_stock">{{__('messages.total_stock')}}</label>                                
                        ...
                        <div class="col-sm-6" id="addon_input">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">{{__('messages.addon')}}<span
                                        class="input-label-secondary" title="{{__('messages.addon')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.store_required_warning')}}"></span></label>                                
                    ...
                    <div class="form-group">
                        <label class="text-dark">{{__('messages.item')}} {{__('messages.thumbnail')}}</label><small style="color: red">* ( {{__('messages.ratio')}} 1:1 )</small>
                    ...
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{__('messages.item')}} {{__('messages.images')}}</label>
                        <div>
...
@push('script_2')
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            // $('input[name^="stock_"]').on('change', function(){
            //     var totalStock = 0;
        ...
        $('#choice_attributes').on('change', function () {
            if(module_id == 0)
            {
                toastr.error('{{__("messages.select_a_module")}}', {
                    CloseButton: true,
                    ProgressBar: true
                });
                $(this).val("");
