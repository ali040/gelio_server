                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select id="store" name="store_id" data-placeholder="{{__('messages.select')}} {{__('messages.store')}}" onchange="getAccountData('{{url('/')}}/admin/vendor/get-account-data/',this.value,'store')" class="form-control" title="Select Restaurant" disabled>
