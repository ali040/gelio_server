                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="module_id" class="form-control js-select2-custom"  title="{{__('messages.select')}} {{__('messages.module')}}" id="module_select" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="zone_id" id="zone" class="form-control js-select2-custom" onchange="getRequest('{{url('/')}}/admin/item/get-items?zone_id='+this.value,'choice_item')">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="banner_type" class="form-control" onchange="banner_type_change(this.value)">
                                            <option value="store_wise" {{$banner->type == 'store_wise'? 'selected':'' }}>{{__('messages.store')}} {{__('messages.wise')}}</option>
                                            <option value="item_wise" {{$banner->type == 'item_wise'? 'selected':'' }}>{{__('messages.item')}} {{__('messages.wise')}}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" id="item_wise">
                                        <label class="input-label" for="exampleFormControlInput1">{{__('messages.select')}} {{__('messages.item')}}</label>
                                        <select name="item_id" id="choice_item" class="form-control js-select2-custom" placeholder="{{__('messages.select_item')}}">
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            $('#zone').on('change', function(){
                ...
                {
                    zone_id = $(this).val();
                    getRequest('{{url('/')}}/admin/item/get-items?zone_id='+zone_id,'choice_item')
                }
                else
                {
                    zone_id = true;
        ...
        getRequest('{{url('/')}}/admin/item/get-items?zone_id={{$banner->zone_id}}&data[]={{$banner->data}}','choice_item');
        @endif 
