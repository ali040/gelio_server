                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="module_id" required
                                                class="form-control js-select2-custom"  data-placeholder="{{__('messages.select')}} {{__('messages.module')}}" id="module_select">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="banner_type" class="form-control" onchange="banner_type_change(this.value)">
                                            <option value="store_wise">{{__('messages.store')}} {{__('messages.wise')}}</option>
                                            <option value="item_wise">{{__('messages.item')}} {{__('messages.wise')}}</option>
                                        </select>
                                    </div>
            ...
            $.post({
                ...
                success: function (data) {
                    if (data.errors) {
                        ...
                        toastr.success('{{__("messages.banner_added_successfully")}}', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function () {
