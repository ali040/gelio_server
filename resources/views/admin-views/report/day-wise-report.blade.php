            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-6 mb-2">
                    <select name="zone_id" class="form-control js-select2-custom"
                        ...
                        <option value="" {{!isset($zone)?'selected':''}}>{{__('messages.all')}} {{__('messages.zone')}}</option>
        ...
        <div class="card px-3">
            <div class="row" style="border-radius: 10px">
                ...
                @php
                    ...
                    $store_earned=$order_transactions->sum('restaurant_amount');
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="mb-1 text-capitalize">{{__('messages.store')}} {{__('messages.earned')}}</h4>
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th  style="width: 10%">{{__('messages.store_commission')}}</th>
