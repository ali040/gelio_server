                ...
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="hs-unfold ml-1">
                            <h5>
                                <i class="tio-shop"></i>
                                {{__('messages.store')}} : <label
                                    class="badge badge-secondary">{{Str::limit($order->store?$order->store->name:__('messages.store deleted!'), 25,'...')}}</label>
                            </h5>
                        </div>                            
                        @endif
        ...
        <div class="row" id="printableArea">
            <div class="col-lg-8 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-header" style="display: block!important;">
                        ...
                        <div class="row">
                            <div class="col-6 pt-2">
                                ...
                                <h5 class="text-dark">
                                    {{__('messages.prescription')}}:
                                </h5>
                                    <button class="btn w-100"  data-toggle="modal" data-target="#imagemodal" title="{{__('messages.order')}} {{__('messages.attachment')}}">
                                        <div class="gallary-card">
                                            <img src="{{asset('storage/app/'.'public/order/'.$order->order_attachment)}}" alt="{{__('messages.prescription')}}" style="height:auto;width:50%;">
                                        </div>    
                                    </button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabel">{{__('messages.prescription')}}</h4>
                                                ...
                                                <div class="modal-footer">
                                                    <a class="btn btn-primary" href="{{route('admin.file-manager.download', base64_encode('public/order/'.$order->order_attachment))}}"><i class="tio-download"></i> {{__('messages.download')}} </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12" id="items">
                                <div class="d-flex flex-wrap mt-2 mb-3" style="justify-content: space-around;">
                                    @foreach($products as $product)
                                        <div class="item-box">
                                            @include('admin-views.order.partials._single_product',['product'=>$product, 'store_data'=>$order->store])
                                            {{--<hr class="d-sm-none">--}}
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <div class="media">
                            <div class="avatar avatar-xl mr-3" title="{{$order->parcel_category->name}}">
                                <img class="img-fluid"
                                    src="{{asset('storage/app/public/parcel_category')}}/{{$order->parcel_category->image}}"
                                    onerror="this.src='{{asset('public/assets/admin/img/160x160/img2.jpg')}}'">
                            </div>
                            <div class="media-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        <strong> {{Str::limit($order->parcel_category->name,20,'...')}}</strong><br>
                                        <div class="font-size-sm text-body">
                                            <span>{{$order->parcel_category->description}}</span>
                                        </div>
                                    </div>
                                    ...
                                    <h6>{{__('messages.delivery_charge')}}</h6>
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-sm-6">{{\App\CentralLogics\Helpers::format_currency($product_price+$del_c+$total_tax_amount+$total_addon_price-$coupon_discount_amount - $store_discount_amount)}}</dd>
                                </dl>
                                <!-- End Row -->
                            </div>
                            @if($editing)
            ...
            <div class="col-lg-4">
                    ...
                    @if($order->customer)
                        <div class="card-body">
                            ...
                            @if($order->delivery_address)
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5>{{__($parcel_order?'messages.sender':'messages.delivery')}} {{__('messages.info')}}</h5>
                            ...
                            @if($order->receiver_details)
                                ...
                                @if(isset($receiver_details))
                                    ...
                                    {{__('messages.contact')}}:<a class="deco-none" href="tel:{{$receiver_details['contact_person_number']}}"> {{$receiver_details['contact_person_number']}}</a><br>
                ...
                <div class="card">
                    ...
                    <!-- Body -->
                    <div class="card-body">
                        <a class="media align-items-center deco-none" href="{{route('admin.vendor.view',[$order->store['id']])}}">
                            <div class="avatar avatar-circle mr-3">
                                <img
                                    class="avatar-img" style="width: 75px"
                                    onerror="this.src='{{asset('public/assets/admin/img/160x160/img1.jpg')}}'"
                                    src="{{asset('storage/app/public/restaurant/'.$order->store->logo)}}"
                                    alt="Image Description">
                            </div>
                            <div class="media-body">
                                <span class="text-body text-hover-primary text-break">{{$order->store->name}}</span><br>
                                <span class="badge badge-ligh">{{$order->store->orders_count}} {{__('messages.orders_served')}}</span>
                            </div>
                        </a>
                        <hr>
...
@push('script_2')
    ...
    <script>
        ...
        @else
        var myLatlng = new google.maps.LatLng({{$order->store->latitude}}, {{$order->store->longitude}});
        @endif
