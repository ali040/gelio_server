            ...
            <div class="col-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12">
                        ...
                        <h5><u>{{__('messages.sender')}} {{__('messages.info')}}</u></h5>
                        <span>
                            {{__('messages.sender')}} {{__('messages.name')}} : {{isset($address)?$address['contact_person_name']:$order->address['f_name'].' '.$order->customer['l_name']}}
                        </span><br>
                        <span>
                            {{__('messages.phone')}} : {{isset($address)?$address['contact_person_number']:$order->customer['phone']}}
                        </span><br>
                        <span class="text-break">
                            {{__('messages.address')}} : {{isset($address)?$address['address']:''}}
                        </span>
                        <br>
                        <br>
                        @php($address=$order->receiver_details)
                        <h5><u>{{__('messages.receiver')}} {{__('messages.info')}}</u></h5>
                        <span>
                            {{__('messages.receiver')}} {{__('messages.name')}} : {{isset($address)?$address['contact_person_name']:$order->address['f_name'].' '.$order->customer['l_name']}}
                        </span><br>
                        <span>
                            {{__('messages.phone')}} : {{isset($address)?$address['contact_person_number']:$order->customer['phone']}}
                        </span><br>
