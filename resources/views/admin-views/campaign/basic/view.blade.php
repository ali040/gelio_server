                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th style="width: 20%">{{__('messages.store')}}</th>
                                ...
                                <th colspan="3">
                                    <form action="{{route('admin.campaign.addstore',$campaign->id)}}" id="store-add-form" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <button type="submit" class="btn btn-primary col-md-5">{{__('messages.add')}} {{__('messages.store')}}</button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-white text-danger" href="javascript:"
                                            onclick="form_alert('campaign-{{$campaign['id']}}','Want to remove this store ?')" title="{{__('messages.delete')}} {{__('messages.campaign')}}"><i class="tio-delete-outlined"></i>
                                        </a>
