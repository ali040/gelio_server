            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-sm-3 border-left text-center">
                        <span class="mb-1">{{__('messages.store')}} {{__('messages.info')}}</span>
                        @if($campaign->store)
                        <a href="{{route('admin.vendor.view', $campaign->store_id)}}" title="{{$campaign->store['name']}}">
                            <img
                        ...
                        @else
                        <span class="badge-info">{{__('messages.store')}} {{__('messages.deleted')}}</span>
                        @endif
                    </div>
                ...
                <table id="datatable"
                    ...
                    @foreach($orders as $key=>$order)
                        ...
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            <td>
                                <label class="badge badge-soft-primary">{{Str::limit($order->order->store?$order->order->store->name:__('messages.store deleted!'),20,'...')}}</label>
                            </td>
                            <td>
