                ...
                <form action="javascript:" method="post" id="campaign_form"
                    ...
                    <div class="card mb-1 p-4" id="{{$default_lang}}-form">
                        <div class="form-group">
                            ...
                            <input type="text" name="title[]" class="form-control" placeholder="{{__('messages.new_item')}}" required>
                        </div>
                            ...
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">{{__('messages.sub_category')}}
                                    <span class="input-label-secondary" title="{{__('messages.category_required_warning')}}">
                                        <img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.category_required_warning')}}">
                                    </span>
                                </label>
