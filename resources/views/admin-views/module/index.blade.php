    ...
    <div class="content container-fluid">
        ...
        <div class="card mt-3">
            <div class="card-header pb-0">
                <h5>{{__('messages.module')}} {{__('messages.list')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$modules->total()}}</span></h5>
                {{--<form id="dataSearch">
                    @csrf
                    <!-- Search -->
                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th style="width: 20%">{{__('messages.module_type')}}</th>
                                <th style="width: 10%">{{__('messages.status')}}</th>
                                <th style="width: 20%">{{__('messages.store_count')}}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-white"
                                        href="{{route('admin.module.edit',[$module['id']])}}" title="{{__('messages.edit')}} {{__('messages.category')}}"><i class="tio-edit"></i>
                                    </a>
                                </td>
                            </tr>
                        @endforeach
