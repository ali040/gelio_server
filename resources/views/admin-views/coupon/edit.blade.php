            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.coupon.update',[$coupon['id']])}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="module_id" required class="form-control js-select2-custom"  data-placeholder="{{__('messages.select')}} {{__('messages.module')}}" id="module">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="coupon_type" class="form-control" onchange="coupon_type_change(this.value)">
                                    <option value="store_wise" {{$coupon['coupon_type']=='store_wise'?'selected':''}}>{{__('messages.store')}} {{__('messages.wise')}}</option>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group" id="store_wise" style="display: {{$coupon['coupon_type']=='store_wise'?'block':'none'}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" max="999999999999.99" step="0.01" value="{{$coupon['max_discount']}}" name="max_discount" id="max_discount" class="form-control" {{$coupon['discount_type']=='percent'?'readonly':''}}>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="form-group">
